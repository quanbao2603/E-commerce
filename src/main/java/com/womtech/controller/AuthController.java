...
public class AuthController {
    ...
    public String doLogin(@RequestParam("username") String username,
        ...
        LoginResponse res = userService.login(LoginRequest.builder()
                .username(username)
                .password(password)
                .build());
    ...
    public Object refreshToken(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (rtCk == null) return Map.of("ok", false, "message", "Missing refresh token");
    ...
    private String resolveRedirectByRoles(List<String> roles) {
        ...
        Set<String> rs = roles.stream().filter(Objects::nonNull)
