...
public class VendorController {
	...
	public String vendorDashboard(Authentication authentication, Model model) {
        ...
        Long pendingOrders = orderService.countOrdersByVendorIdAndStatus(currentUser.getUserID(), OrderStatusHelper.STATUS_PENDING);
        Long shippedOrders = orderService.countOrdersByVendorIdAndStatus(currentUser.getUserID(), OrderStatusHelper.STATUS_SHIPPED);
        Long deliveredOrders = orderService.countOrdersByVendorIdAndStatus(currentUser.getUserID(), OrderStatusHelper.STATUS_DELIVERED);
        
        // Get recent orders
        List<Order> recentOrders = orderService.getOrdersByVendorId(currentUser.getUserID())
