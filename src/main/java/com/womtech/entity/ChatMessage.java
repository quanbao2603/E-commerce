...
@Table(name = "chat_messages",
       indexes = @Index(name="idx_chat_messages_chat", columnList="chatID"))
...
public class ChatMessage {
    ...
    private User sender; // user hoặc support

    @Lob @Column(nullable=false) private String message;

    @CreationTimestamp @Column(name="send_time", updatable=false)
